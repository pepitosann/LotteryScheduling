...
void main(void)
{
	...
	xReturned_1 = xTaskCreate(	vTask1, 				// Pointer to the task entry function (name of function)
								...
								55						// Number of tickets that the task has
            					);

	xReturned_2 = xTaskCreate(vTask2, "vTask2", STACK_SIZE, (void *)paramTask2, TASK_2_PRIORITY, &xHandle_2, 15);
	xReturned_3 = xTaskCreate(vTask3, "vTask3", STACK_SIZE, (void *)paramTask3, TASK_3_PRIORITY, &xHandle_3, 30);
